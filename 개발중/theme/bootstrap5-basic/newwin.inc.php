...
<section class="popup" id='hd_pop'>
    ...
    ?>
        <div id="hd_pops_<?php echo $nw['nw_id'] ?>" class="hd_pops shadow" style="top:<?php echo $nw['nw_top'] ?>px;left:<?php echo $nw['nw_left'] ?>px">
    ...
    <?php }
    if ($i == 0) echo '<span class="visually-hidden">팝업레이어 알림이 없습니다.</span>';
    ?>
</section>
