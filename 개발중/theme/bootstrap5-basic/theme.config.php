...
$theme_config = array(
    ...
    'de_mobile_type1_img_width'     => 400,     // 모바일 히트상품 이미지 폭
    ...
    'de_mobile_type5_img_width'     => 400,     // 모바일 할인상품 이미지 폭
    ...
    'de_rel_img_width'              => 400,     // 관련상품 이미지 폭
    ...
    'de_mobile_rel_img_width'       => 400,     // 모바일 관련상품 이미지 폭
    ...
    'de_search_img_width'           => 400,     // 검색상품 이미지 폭
    ...
    'ev_img_width'                  => 400,     // 이벤트 리스트 이미지 폭
...
define('BB_ASSETS_DIR', 'assets');
define('BB_ASSETS_URL', G5_URL . '/' . BB_ASSETS_DIR);
//다크모드 토글 사용여부 - 추후 지원예정
define('BB_DARK_MODE', false);
//CSS, JS 파일 합치기, 압축하기 사용, 사이트 제작 완료시 true 사용.
define('BB_CSS_USE_MINIFY', false);
//JS파일 오류 발생시 사용금지
define('BB_JS_USE_MINIFY', false);
//쪽지팝업창으로 열기 설정, true = 팝업창으로 열기, false = 모달창으로 열기
define('BB_MEMO_POPUP', false);
//포인트내역 팝업 열기 설정
define('BB_POINT_POPUP', false);
//스크랩 팝업 열기 설정
define('BB_SCRAP_POPUP', false);
//메일 팝업 열기 설정
define('BB_MAIL_POPUP', false);
//자기소개 팝업 열기 설정
define('BB_PROFILE_POPUP', false);
//영카트 쿠폰 팝업 열기 설정
define('BB_COUPON_POPUP', false);
