    ...
    <div class="main-menu-wrap">
        <div class="container">
            ...
            <div class="category-wrap d-flex justify-content-around">
                ...
                <div class="py-2 flex-fill header-main-nav d-flex justify-content-center <?php echo (isset($type) && $type == 1) ? 'active' : ''; ?>"><a href="<?php echo shop_type_url(1); ?>" class="primary-menu"> 거창한무역</span></a></div>
                <div class="py-2 flex-fill header-main-nav d-flex justify-content-center <?php echo (isset($type) && $type == 2) ? 'active' : ''; ?>"><a href="https://myemall.co.kr/bbs/board.php?bo_table=gallery" class="primary-menu"> 갤러리</span></a></div>
                <div class="py-2 flex-fill header-main-nav d-flex justify-content-center <?php echo (isset($type) && $type == 3) ? 'active' : ''; ?>"><a href="https://blog.naver.com/wpdlf943" class="primary-menu"> 블로그</a></div>            
                <div class="py-2 flex-fill header-main-nav d-flex justify-content-center <?php echo (isset($type) && $type == 4) ? 'active' : ''; ?>"><a href="/shop/list.php?ca_id=10" class="primary-menu"> 사과</span></a></div>
                <div class="py-2 flex-fill header-main-nav d-flex justify-content-center <?php echo (isset($type) && $type == 5) ? 'active' : ''; ?>"><a href="/shop/list.php?ca_id=20" class="primary-menu"> 사과주스</span></a></div>
                <div class="py-2 flex-fill header-main-nav d-flex justify-content-center <?php echo (isset($type) && $type == 5) ? 'active' : ''; ?>"><a href="/shop/list.php?ca_id=30" class="primary-menu"> 포도</span></a></div>
                <div class="py-2 flex-fill header-main-nav d-flex justify-content-center <?php echo (isset($type) && $type == 5) ? 'active' : ''; ?>"><a href="/shop/list.php?ca_id=40" class="primary-menu"> 수입과일</span></a></div>
                <div class="py-2 flex-fill header-main-nav d-flex justify-content-center <?php echo (isset($type) && $type == 5) ? 'active' : ''; ?>"><a href="/shop/list.php?ca_id=50" class="primary-menu"> 양파</span></a></div>
                <div class="py-2 flex-fill header-main-nav d-flex justify-content-center <?php echo (isset($type) && $type == 5) ? 'active' : ''; ?>"><a href="/shop/list.php?ca_id=60" class="primary-menu"> 기타</span></a></div>
            </div>
        </div>
    </div>
