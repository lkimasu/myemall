...
$sql = " update {$g5['g5_shop_default_table']}
            set de_admin_company_owner        = '{$de_admin_company_owner}',
                ...
                de_mobile_type7_list_use      = '{$_POST['de_mobile_type7_list_use']}',
                de_mobile_type7_list_skin     = '{$_POST['de_mobile_type7_list_skin']}',
                de_mobile_type7_list_mod      = '{$_POST['de_mobile_type7_list_mod']}',
                de_mobile_type7_list_row      = '{$_POST['de_mobile_type7_list_row']}',
                de_mobile_type7_img_width     = '{$_POST['de_mobile_type7_img_width']}',
                de_mobile_type7_img_height    = '{$_POST['de_mobile_type7_img_height']}',
                ...
                de_mobile_type8_list_use      = '{$_POST['de_mobile_type8_list_use']}',
                de_mobile_type8_list_skin     = '{$_POST['de_mobile_type8_list_skin']}',
                de_mobile_type8_list_mod      = '{$_POST['de_mobile_type8_list_mod']}',
                de_mobile_type8_list_row      = '{$_POST['de_mobile_type8_list_row']}',
                de_mobile_type8_img_width     = '{$_POST['de_mobile_type8_img_width']}',
                de_mobile_type8_img_height    = '{$_POST['de_mobile_type8_img_height']}',
                ...
                de_mobile_type9_list_use      = '{$_POST['de_mobile_type9_list_use']}',
                de_mobile_type9_list_skin     = '{$_POST['de_mobile_type9_list_skin']}',
                de_mobile_type9_list_mod      = '{$_POST['de_mobile_type9_list_mod']}',
                de_mobile_type9_list_row      = '{$_POST['de_mobile_type9_list_row']}',
                de_mobile_type9_img_width     = '{$_POST['de_mobile_type9_img_width']}',
                de_mobile_type9_img_height    = '{$_POST['de_mobile_type9_img_height']}',
                ...
                de_mobile_type10_list_use      = '{$_POST['de_mobile_type10_list_use']}',
                de_mobile_type10_list_skin     = '{$_POST['de_mobile_type10_list_skin']}',
                de_mobile_type10_list_mod      = '{$_POST['de_mobile_type10_list_mod']}',
                de_mobile_type10_list_row      = '{$_POST['de_mobile_type10_list_row']}',
                de_mobile_type10_img_width     = '{$_POST['de_mobile_type10_img_width']}',
                de_mobile_type10_img_height    = '{$_POST['de_mobile_type10_img_height']}',
                de_type11_list_use             = '{$_POST['de_type11_list_use']}',
                de_type11_list_skin            = '{$_POST['de_type11_list_skin']}',
                de_type11_list_mod             = '{$_POST['de_type11_list_mod']}',
                de_type11_list_row             = '{$_POST['de_type11_list_row']}',
                de_type11_img_width            = '{$_POST['de_type11_img_width']}',
                de_type11_img_height           = '{$_POST['de_type11_img_height']}',
                de_mobile_type11_list_use      = '{$_POST['de_mobile_type11_list_use']}',
                de_mobile_type11_list_skin     = '{$_POST['de_mobile_type11_list_skin']}',
                de_mobile_type11_list_mod      = '{$_POST['de_mobile_type11_list_mod']}',
                de_mobile_type11_list_row      = '{$_POST['de_mobile_type11_list_row']}',
                de_mobile_type11_img_width     = '{$_POST['de_mobile_type11_img_width']}',
                de_mobile_type11_img_height    = '{$_POST['de_mobile_type11_img_height']}',
