...
<div id="bo_gall">
    ...
    <div class="bo_fx">
	    ...
	    <ul class="btn_bo_user btn_bo_user_top">
	        <?php if ($rss_href) { ?><li><a href="<?php echo $rss_href ?>" class="btn_b01"><i class="fa fa-rss" aria-hidden="true"></i> RSS</a></li><?php } ?>
	        <?php if ($admin_href) { ?><li><a href="<?php echo $admin_href ?>" class="btn_admin"><i class="fa fa-cog" aria-hidden="true"></i> 관리자</a></li><?php } ?>
    ...
    <ul id="gall_ul">
        ...
        <li class="gall_li">
            ...
            <ul class="gall_con">
                ...
                <li class="gall_text"><span class="gall_subject"><i class="fa fa-user" aria-hidden="true"></i></span><?php echo $list[$i]['name'] ?></li>
                <li class="gall_text">
                	<span class="gall_subject"><i class="fa fa-clock-o" aria-hidden="true"></i></span><?php echo $list[$i]['datetime2'] ?>
                	<span class="gall_subject"><i class="fa fa-eye" aria-hidden="true"></i></span><?php echo $list[$i]['wr_hit'] ?>
                </li>
                <li class="gall_text">
                <?php if ($is_good) { ?><span class="gall_subject gall_good"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i></span><strong><?php echo $list[$i]['wr_good'] ?></strong><?php } ?>
                <?php if ($is_nogood) { ?><span class="gall_subject gall_nogood"><i class="fa fa-thumbs-o-down" aria-hidden="true"></i></span><strong><?php echo $list[$i]['wr_nogood'] ?></strong><?php } ?>
                </li>
            </ul>
        </li>
        <?php } ?>
