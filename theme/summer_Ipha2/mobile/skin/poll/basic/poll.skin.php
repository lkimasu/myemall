...
<aside id="poll">
    <header>
        <h2><i class="fa fa-area-chart" aria-hidden="true"></i> 설문조사</h2>
        <?php if ($is_admin == "super") { ?><a href="<?php echo G5_ADMIN_URL ?>/poll_form.php?w=u&amp;po_id=<?php echo $po_id ?>" class="btn_admin"><i class="fa fa-cog" aria-hidden="true"></i> 설문조사 관리</a><?php } ?>
