    ...
    <div  id="register_form">
        ...
        <div class="tbl_frm01 tbl_wrap">
            ...
            <tr>
                ...
                <td><input type="text" name="mb_tel"  placeholder="전화번호" value="<?php echo get_text($member['mb_tel']) ?>" id="reg_mb_tel" class="frm_input <?php echo $config['cf_req_tel']?"required":""; ?>" maxlength="20" <?php echo $config['cf_req_tel']?"required":""; ?>></td>
            </tr>
            <?php } ?>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="mb_hp"  placeholder="휴대폰번호"  value="<?php echo get_text($member['mb_hp']) ?>" id="reg_mb_hp" <?php echo ($config['cf_req_hp'])?"required":""; ?> class="frm_input <?php echo ($config['cf_req_hp'])?"required":""; ?>" maxlength="20">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text"  placeholder="우편번호" name="mb_zip" value="<?php echo $member['mb_zip1'].$member['mb_zip2']; ?>" id="reg_mb_zip" <?php echo $config['cf_req_addr']?"required":""; ?> class="frm_input1 <?php echo $config['cf_req_addr']?"required":""; ?>" size="5" maxlength="6">
                    ...
                    <input type="text" placeholder="주소" name="mb_addr1" value="<?php echo get_text($member['mb_addr1']) ?>" id="reg_mb_addr1" <?php echo $config['cf_req_addr']?"required":""; ?> class="frm_input frm_address <?php echo $config['cf_req_addr']?"required":""; ?>" size="50"><br>
                    <label for="reg_mb_addr2" class="sound_only">상세주소</label>
                    <input type="text" placeholder="상세주소"  name="mb_addr2" value="<?php echo get_text($member['mb_addr2']) ?>" id="reg_mb_addr2" class="frm_input frm_address" size="50">
                    <br>
